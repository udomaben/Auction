...
const Button = ({
  ...
  const variants = {
    ...
    secondary: 'bg-neutral-secondary text-neutral-dark-gray hover:bg-neutral-tertiary focus:ring-neutral-tertiary',
    ...
    ghost: 'text-neutral-dark-gray hover:bg-neutral-secondary focus:ring-neutral-tertiary',
  }
